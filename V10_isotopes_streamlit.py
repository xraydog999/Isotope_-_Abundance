...
explanations = [
    ...
    "0.7577x34.97+0.2423x36.97, Weighted average using fractional abundances and isotope masses.",
    "0.787x23.95+0.1013x24.986+0.1116x25.983,Multiply each mass by its fractional abundance and sum the contributions."
]
